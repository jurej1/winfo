...
export const tokenNonTxFormatter: Formatter = {
  rules: [
    ...
    { upperBound: 1, formatter: TwoDecimals },
...
export const tokenTxFormatter: Formatter = {
  rules: [
    { exact: 0, formatter: "0" },
    {
      ...
      formatter: TOKEN_AMOUNT_DISPLAY_FLOOR_FALLBACK,
    },
...
const percentagesThreeDecimalsFormatter: Formatter = {
  rules: [
    { upperBound: Infinity, formatter: NoTrailingThreeDecimalsPercentages },
  ],
...
const percentagesFourDecimalsFormatter: Formatter = {
  rules: [
    { upperBound: Infinity, formatter: NoTrailingFourDecimalsPercentages },
  ],
